...
class SelColsTablePage()(implicit val xsh: XSPageHandle) extends MenuPage with DemoCodePage {

  override def pageCodeFile = "app/pages/tableexamples/SelColsTablePage.scala"
  override def pageTitle: String = Menu.tableSectionSelColsTable.name
      ...
      TH.Row("margin-bottom: 30px;")(
        TH.Col().md12 {
          ...
          new TH.Widget {
            ...
            override def widgetTitle: String = "Select Columns Table Example"
            override def widgetBody: NodeSeq = new TH.SelColsTable {
              override def selColSelected: NodeSeq = TH.IcnFA.icn_check_square_o.icn
              override def selColUnselected: NodeSeq = TH.IcnFA.icn_square_o.icn
              ...
              override lazy val allColumns: Seq[C] = List(
