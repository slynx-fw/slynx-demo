...
class BasicTablePage()(implicit val xsh: XSPageHandle) extends MenuPage with DemoCodePage {

  override def pageCodeFile = "app/pages/tableexamples/BasicTablePage.scala"
  override def pageTitle: String = Menu.tableSectionTables.name
  override def pageSubtitle: String = "Basic, non-interactive table"
      ...
      TH.Row("margin-bottom: 30px;")(
         TH.Col().md12 {
          ...
          new TH.Widget {
            ...
            override def widgetTitle: String = "Table Example"
            override def widgetBody: NodeSeq = new TH.Table {
